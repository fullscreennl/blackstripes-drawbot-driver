...
#define CANVAS_Y 330
#define MOVEMENT_STEP ((4.71*13)/(3200.0*4.0)) //800 microsteps, 13 tooth sprocket, rack pitch 4.71mm
#define ANGLE_PER_STEP (360.0/(3200.0*4.0)) //3200 microsteps, 1:50 gearbox
